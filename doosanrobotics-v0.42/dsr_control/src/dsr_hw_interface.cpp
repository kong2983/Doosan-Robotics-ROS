    ...
    void DRHWInterface::OnMonitoringAccessControlCB(const MONITORING_ACCESS_CONTROL eAccCtrl)
    {
        ...
        case MONITORING_ACCESS_CONTROL_LOSS:
            ...
            if (g_bTpInitailizingComplted) {
                ...
                //Drfl.TransitControlAuth(MANAGE_ACCESS_CONTROL_FORCE_REQUEEST);
            }
            break;
        default:
            break;
    ...
    */
    ...
    DRHWInterface::DRHWInterface(ros::NodeHandle nh)
    {
        ...
        */
        ...
        ros::param::get("~name", m_strRobotName);
        ros::param::get("~model", m_strRobotModel);
        ...
        // Publisher msg 
        m_PubRobotState = nh.advertise<dsr_msgs::RobotState>("state",100);
        m_PubRobotError = nh.advertise<dsr_msgs::RobotError>("error",100);
        m_PubtoGazebo = nh.advertise<std_msgs::Float64MultiArray>("/dsr_joint_position_controller/command",10);
        m_PubtoGazeboGripper = nh.advertise<std_msgs::Float64>("/gripper_controller/command", 10);

        m_sub_joint_trajectory = nh.subscribe("dsr_joint_trajectory_controller/follow_joint_trajectory/goal", 10, &DRHWInterface::trajectoryCallback, this); //for MoveIt
        m_sub_joint_position = nh.subscribe("dsr_joint_position_controller/command", 10, &DRHWInterface::positionCallback, this);

        //  motion Operations
        m_nh_move_service[0] = nh.advertiseService("motion/move_joint", &DRHWInterface::movej_cb, this);
        m_nh_move_service[1] = nh.advertiseService("motion/move_line", &DRHWInterface::movel_cb, this);
        m_nh_move_service[2] = nh.advertiseService("motion/move_jointx", &DRHWInterface::movejx_cb, this);
        m_nh_move_service[3] = nh.advertiseService("motion/move_circle", &DRHWInterface::movec_cb, this);
        m_nh_move_service[4] = nh.advertiseService("motion/move_spline_joint", &DRHWInterface::movesj_cb, this);
        m_nh_move_service[5] = nh.advertiseService("motion/move_spline_task", &DRHWInterface::movesx_cb, this);
        m_nh_move_service[6] = nh.advertiseService("motion/move_blending", &DRHWInterface::moveb_cb, this);
        m_nh_move_service[7] = nh.advertiseService("motion/move_spiral", &DRHWInterface::movespiral_cb, this);
        m_nh_move_service[8] = nh.advertiseService("motion/move_periodic", &DRHWInterface::moveperiodic_cb, this);
        m_nh_move_service[9] = nh.advertiseService("motion/move_wait", &DRHWInterface::movewait_cb, this);

        //  GPIO Operations
        m_nh_io_service[0] = nh.advertiseService("io/set_digital_output", &DRHWInterface::set_digital_output_cb, this);
        m_nh_io_service[1] = nh.advertiseService("io/get_digital_input", &DRHWInterface::get_digital_input_cb, this);
        m_nh_io_service[2] = nh.advertiseService("io/set_tool_digital_output", &DRHWInterface::set_tool_digital_output_cb, this);
        m_nh_io_service[3] = nh.advertiseService("io/get_tool_digital_input", &DRHWInterface::get_tool_digital_input_cb, this);
        m_nh_io_service[4] = nh.advertiseService("io/set_analog_output", &DRHWInterface::set_analog_output_cb, this);
        m_nh_io_service[5] = nh.advertiseService("io/get_analog_input", &DRHWInterface::get_analog_input_cb, this);
        m_nh_io_service[6] = nh.advertiseService("io/set_analog_output_type", &DRHWInterface::set_analog_output_type_cb, this);
        m_nh_io_service[7] = nh.advertiseService("io/set_analog_input_type", &DRHWInterface::set_analog_input_type_cb, this);

        //  Modbus Operations
        m_nh_modbus_service[0] = nh.advertiseService("modbus/set_modbus_output", &DRHWInterface::set_modbus_output_cb, this);
        m_nh_modbus_service[1] = nh.advertiseService("modbus/get_modbus_input", &DRHWInterface::get_modbus_input_cb, this);
        m_nh_modbus_service[2] = nh.advertiseService("modbus/config_create_modbus", &DRHWInterface::config_create_modbus_cb, this);
        m_nh_modbus_service[3] = nh.advertiseService("modbus/config_delete_modbus", &DRHWInterface::config_delete_modbus_cb, this);

        // TCP Operations
        m_nh_tcp_service[0] = nh.advertiseService("tcp/set_current_tcp", &DRHWInterface::set_current_tcp_cb, this);
        m_nh_tcp_service[1] = nh.advertiseService("tcp/get_current_tcp", &DRHWInterface::get_current_tcp_cb, this);
        m_nh_tcp_service[2] = nh.advertiseService("tcp/config_create_tcp", &DRHWInterface::config_create_tcp_cb, this);
        m_nh_tcp_service[3] = nh.advertiseService("tcp/config_delete_tcp", &DRHWInterface::config_delete_tcp_cb, this);

        // Tool Operations
        m_nh_tool_service[0] = nh.advertiseService("tool/set_current_tool", &DRHWInterface::set_current_tool_cb, this);
        m_nh_tool_service[1] = nh.advertiseService("tool/get_current_tool", &DRHWInterface::get_current_tool_cb, this);
        m_nh_tool_service[2] = nh.advertiseService("tool/config_create_tool", &DRHWInterface::config_create_tool_cb, this);
        m_nh_tool_service[3] = nh.advertiseService("tool/config_delete_tool", &DRHWInterface::config_delete_tool_cb, this);

        // DRL Operations
        m_nh_drl_service[0] = nh.advertiseService("drl/drl_pause", &DRHWInterface::drl_pause_cb, this);
        m_nh_drl_service[1] = nh.advertiseService("drl/drl_resume", &DRHWInterface::drl_resume_cb, this);
        m_nh_drl_service[2] = nh.advertiseService("drl/drl_start", &DRHWInterface::drl_start_cb, this);
        m_nh_drl_service[3] = nh.advertiseService("drl/drl_stop", &DRHWInterface::drl_stop_cb, this);

        // Gripper Operations
        m_nh_gripper_service[0] = nh.advertiseService("gripper/gripper_move", &DRHWInterface::gripper_move_cb, this);
        ...
        // create threads     
        m_th_subscribe = boost::thread( boost::bind(&thread_subscribe, nh) );
        m_th_publisher = boost::thread( boost::bind(&thread_publisher, this, nh, DSR_CTL_PUB_RATE/*hz*/) );    //100hz(10ms)     
    }
    ...
    bool DRHWInterface::init()
    {
        ...
        ros::param::get("~ipaddress", ipaddress);
        printf("ipaddress = %s\n", ipaddress.c_str());
        printf("ipaddress = %s\n", ipaddress.c_str());
        printf("ipaddress = %s\n", ipaddress.c_str());
        ros::param::param<bool>("~command", bCommand_, false);
        std::cout << "param is " << bCommand_ << "\n";
        std::string mode;
    ...
    bool DRHWInterface::gripper_move_cb(dsr_msgs::GripperMove::Request& req, dsr_msgs::GripperMove::Response& res)
    {
        ROS_INFO("DRHWInterface::gripper_move_cb() called and calling Nothing");

        float goal_pos = req.maxLength;
        ROS_INFO("1");
        ROS_INFO("current pos : %7.3f", joints[6].pos);
