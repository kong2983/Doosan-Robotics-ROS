...
namespace dsr_control{
    ...
    private:
        ...
        //----- Gripper
        bool gripper_move_cb(dsr_msgs::GripperMove::Request& req, dsr_msgs::GripperMove::Response& res);
